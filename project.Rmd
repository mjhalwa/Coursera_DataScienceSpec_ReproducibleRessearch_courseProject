...
data$EVTYPE <- as.factor(gsub("^(frost|freez).*","frost/freeze",data$EVTYPE))
data$EVTYPE <- as.factor(gsub(".*freez.*[^f][^o][^g]","frost/freeze",data$EVTYPE))
data$EVTYPE <- as.factor(gsub("^driest*","drought",data$EVTYPE))
data$EVTYPE <- as.factor(gsub("^downburst$","thunderstorm wind",data$EVTYPE))
data$EVTYPE <- as.factor(gsub("^[fv]og","dense fog",data$EVTYPE))
data$EVTYPE <- as.factor(gsub("^hail.*","hail",data$EVTYPE))
